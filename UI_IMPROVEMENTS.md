...
The application has been significantly enhanced with a modern, professional design that follows global UI/UX standards
and best practices. All major pages now feature a consistent sidebar navigation, responsive layout, and improved visual
hierarchy.
  ...
  return (
    <MainLayout>
      <div className='flex flex-col'>
        ...
        <div className='flex-1 px-6 py-8 sm:px-8'>{/* Your content here */}</div>
      </div>
    </MainLayout>
  );
}
