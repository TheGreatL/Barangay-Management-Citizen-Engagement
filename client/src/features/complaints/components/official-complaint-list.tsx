...
import { AlertCircle, MapPin, Calendar, Badge, Filter } from 'lucide-react'
...
export function OfficialComplaintList() {
  const [page, setPage] = useState(1)
  const [statusFilter, setStatusFilter] = useState<string>('all')

  const { data, isLoading, error } = useQuery({
    queryKey: ['all-complaints', page, statusFilter],
              ...
              <div className="mb-3 flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs rounded bg-gray-100 px-2 py-1 text-gray-700">
