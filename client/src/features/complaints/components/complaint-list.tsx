...
export function ComplaintList() {
  ...
  if (isLoading) {
    return (
      <div className="border-border/60 bg-muted/30 flex flex-col items-center justify-center space-y-4 rounded-xl border p-12">
  ...
  if (error) {
    return (
      <div className="rounded-xl border border-rose-200/50 bg-rose-50/50 p-8 dark:border-rose-800/50 dark:bg-rose-900/10">
  ...
  return (
    <div className="space-y-6">
      {complaints.length === 0 ? (
        <div className="border-border bg-muted/30 flex flex-col items-center justify-center rounded-xl border border-dashed p-16 text-center">
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-3 pt-4">
          ...
          <span className="bg-muted text-muted-foreground rounded-lg px-3 py-1.5 text-xs font-medium">
